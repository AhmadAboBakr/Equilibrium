	 ...
	 public class SaveData
    {
        ...
        public void CreateSaveFile()
        {
            ...
            if (!File.Exists("Saved.bin"))
            {
                ...
                XmlWriter writer = XmlWriter.Create("Saved.bin", settings);
                writer.WriteStartDocument();
                writer.WriteComment("This file is generated by the equilibrium.");
        ...
        public void SaveItem(string key, string value)
        {
            if (!File.Exists("Saved.bin"))
            {
                throw new FileNotFoundException("Save File Is Not Exist Please Create One");
            }
            else
            {
